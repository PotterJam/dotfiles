...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_split_3x5_2(KC_ESC, OSM(MOD_LCTL), KC_TRNS, KC_C, KC_V, KC_HOME, KC_CIRC, KC_UP, KC_DLR, KC_ESC,
        OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), KC_ENT, KC_END, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL, KC_TRNS, KC_LGUI, KC_LALT, KC_TRNS, LGUI(KC_Z), KC_TRNS, KC_TAB, CW_TOGG, KC_PGUP, KC_PGDN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
    ...
    [3] = LAYOUT_split_3x5_2(KC_LBRC, KC_7, KC_8, KC_9, KC_RBRC, KC_F6, KC_F9, KC_F10, KC_F11, KC_F12, KC_HASH, KC_4, KC_5, KC_6, KC_PERC, KC_F7, OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), KC_GRV, KC_1, KC_2, KC_3, KC_BSLS, KC_F8, KC_F2, KC_F3, KC_F4, KC_F5, KC_DOT, KC_0, KC_TRNS, KC_TRNS)
};
