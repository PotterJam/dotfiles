...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_split_3x5_2(KC_B, KC_L, KC_D, KC_C, KC_V, KC_J, KC_Y, KC_O, KC_U, KC_COMM, LSFT_T(KC_N), LGUI_T(KC_R), LALT_T(KC_T), LCTL_T(KC_S), KC_G, KC_P, RCTL_T(KC_H), LALT_T(KC_A), RGUI_T(KC_E), RSFT_T(KC_I), KC_X, KC_Q, KC_M, KC_W, KC_Z, KC_K, KC_F, KC_QUOT, KC_UNDS, KC_DOT, LT(4,KC_BSPC), LT(1,KC_TAB), LT(3,KC_SPC), LT(2,KC_ENT)),
