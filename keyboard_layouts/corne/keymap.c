...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAV] = LAYOUT_split_3x6_3(
        ...
        KC_NO, OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), KC_BSPC, KC_CAPS, KC_LEFT, KC_DOWN, KC_RGHT, KC_BSPC, KC_NO,
    ...
    [SYM] = LAYOUT_split_3x6_3(
        KC_NO, KC_ESC, KC_LBRC, KC_LCBR, KC_LPRN, KC_CIRC, KC_PERC, KC_RPRN, KC_RCBR, KC_RBRC, KC_AT, KC_NO,
        KC_NO, KC_PPLS, KC_PMNS, KC_UNDS, KC_PEQL, KC_HASH, KC_TILD, OSM(MOD_LCTL), OSM(MOD_LALT), OSM(MOD_LGUI), OSM(MOD_LSFT), KC_NO,
        KC_NO, KC_EXLM, KC_PIPE, KC_PAST, KC_PSLS, KC_GRV, KC_NO, KC_BSLS, KC_DLR, KC_AMPR, KC_QUES, KC_NO,
        KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO),

    [NUM] = LAYOUT_split_3x6_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PMNS, KC_7, KC_8, KC_9, KC_PSLS, KC_NO,
        KC_NO, OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), KC_NO, KC_PLUS, KC_4, KC_5, KC_6, KC_0, KC_NO,
    ...
    [FKEY] = LAYOUT_split_3x6_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F7, KC_F8, KC_F9, KC_F10, KC_NO,
        KC_NO, OSM(MOD_LSFT), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), KC_NO, KC_NO, KC_F4, KC_F5, KC_F6, KC_F11, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, EE_CLR, KC_NO, KC_F1, KC_F2, KC_F3, KC_F12, KC_NO,
                KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO)
};
